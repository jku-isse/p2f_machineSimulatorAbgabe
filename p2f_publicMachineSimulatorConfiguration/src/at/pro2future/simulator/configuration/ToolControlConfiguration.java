...
public class ToolControlConfiguration implements Supplier<List<EObject>> {
	...
	public ToolControlConfiguration() {
		...
		this.sim.getActions().add(ConfigurationUtil.initializeAction(opcUaClientInterface, millingStartEvent, Arrays.asList(opcUaIsMilling), SimulatorFactory.eINSTANCE.createMsWriteAction()));
		this.sim.getActions().add(ConfigurationUtil.initializeAction(opcUaClientInterface, millingStopEvent, Arrays.asList(opcUaIsMilling), SimulatorFactory.eINSTANCE.createMsWriteAction()));
