...
public class MillingControlConfiguration implements Supplier<List<EObject>> {
    ...
    public MillingControlConfiguration(ToolControlConfiguration tcc, WorkpieceControlConfiguration wcc) {
        ...
        millingControlInterface.setInstanceInformation(CommonObjects.MillingControlInstanceInformation); 
        MsClientInterface toolControlInterface = SimulatorFactory.eINSTANCE.createMsClientInterface();
        toolControlInterface.setInstanceInformation(CommonObjects.ToolControlInstanceInformation);
        MsClientInterface workpieceControlInterface = SimulatorFactory.eINSTANCE.createMsClientInterface();
        workpieceControlInterface.setInstanceInformation(CommonObjects.WorkpieceControlInstanceInformation);
        ...
        opcUaServerInterface.setInstanceInformation(CommonObjects.MillingControlInstanceInformation);
        ...
        this.sim.getAdressSpaceActions().add(ConfigurationUtil.msEventAdressSpaceAction(millingControlInterface, runEvent, Arrays.asList(opcUaRun), SimulatorFactory.eINSTANCE.createMsReadEventAdressSpaceAction()));
        this.sim.getAdressSpaceActions().add(ConfigurationUtil.msEventAdressSpaceAction(workpieceControlInterface, workpieceEvent, Arrays.asList(opcUaWorkpiece), SimulatorFactory.eINSTANCE.createMsWriteEventAdressSpaceAction()));
        this.sim.getAdressSpaceActions().add(ConfigurationUtil.msEventAdressSpaceAction(toolControlInterface, toolEvent, Arrays.asList(opcUaTool), SimulatorFactory.eINSTANCE.createMsWriteEventAdressSpaceAction()));
        this.sim.getAdressSpaceActions().add(ConfigurationUtil.msEventAdressSpaceAction(toolControlInterface, startEvent, Arrays.asList(opcUaStart), SimulatorFactory.eINSTANCE.createMsWriteEventAdressSpaceAction()));
        this.sim.getAdressSpaceActions().add(ConfigurationUtil.msEventAdressSpaceAction(toolControlInterface, stopEvent, Arrays.asList(opcUaStart), SimulatorFactory.eINSTANCE.createMsWriteEventAdressSpaceAction()));
